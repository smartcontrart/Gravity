    ...
    return ( 
        <React.Fragment>
            ...
            <Row id="description_row">
                <span>Duality is about choices.</span>
                <span>For each NFT you mint, you can choose between 6 options. 3 visuals and 3 sounds.</span>
                <span>You can also choose not to have audio or video.</span>
            </Row>
            <Row id="visual_row">
